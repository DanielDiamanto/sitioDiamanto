...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<!-- Aqui lo comente para que no tuviera la opcion de ocultar la tabla-->
	<!--
	<div class="mDiv">
		<div class="ftitle">
			&nbsp;
	...
	-->
	<!-- aqui termina la opcion-->
	<div id='main-table-box' class="main-table-box">

	<?php if(!$unset_add || !$unset_export || !$unset_print){?>
	<div class="tDiv" style="background: darkmagenta;">
		<?php if(!$unset_add){?>
		<div class="tDiv2" style="background-color: darkmagenta;">
        	<a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='add-anchor add_button'>
			<div class="fbutton">
				<div>
					<span class="add" style="font-family: fantasy;     font-size: large; color: white;"><?php echo $this->l('list_add'); ?> <?php echo $subject?></span>
				</div>
			</div>
            </a>
			<div class="btnseparator" style="background-color: darkmagenta;">
			</div>
		</div>
		<?php }?>
		<div class="tDiv3" style="font-family: fantasy; color: white; font-size: large; background-color: darkmagenta;">
			<?php if(!$unset_export) { ?>
        	<a class="export-anchor" data-url="<?php echo $export_url; ?>" target="_blank">
				<div class="fbutton" style="font-family: fantasy; font-size: large;color: white;">
					<div>
						<span class="export" style="font-family:fantasy; font-size: large; color: white;"><?php echo $this->l('list_export');?></span>
					</div>
				</div>
            </a>
			<div class="btnseparator" style="font-family: fantasy; color: white;font-size: large; "></div>
			<?php } ?>
			<?php if(!$unset_print) { ?>
        	<a class="print-anchor" data-url="<?php echo $print_url; ?>">
				<div class="fbutton">
					<div>
						<span class="print" style="font-family: fantasy; font-size: large; color: white;"><?php echo $this->l('list_print');?></span>
					</div>
				</div>
            </a>
	...
	<!--AQUI ESTA EL FOOTER DE LA TABLA DESDE LOS INPUT DE BUSQUEDA-->
	<div class="sDiv quickSearchBox" id='quickSearchBox' style="font-family: fantasy;">
		<div class="sDiv2">
		<!--AQUI ESTAN LOS INPUT DE BUSQUEDA-->
			<?php echo $this->l('list_search');?>: <input type="text" class="qsbsearch_fieldox search_text" name="search_text" size="30" id='search_text' style="border-radius: 3px;">
			<select name="search_field" id="search_field" style="border-radius: 3px;height: 24px; font-family:fantasy;">
				<option value=""><?php echo $this->l('list_search_all');?></option>
				<?php foreach($columns as $column){?>
				<option value="<?php echo $column->field_name?>"><?php echo $column->display_as?>&nbsp;&nbsp;</option>
				<?php }?>
			</select>
            <input type="button" value="<?php echo $this->l('list_search');?>" class="crud_search" style="background-color: #9c27b0;color: #ffffff;border-color: #204d74;text-transform: uppercase;border-radius: 4px;font-family: fantasy; font-size: large;" id='crud_search'>
		</div>
        <div class='search-div-clear-button' >
        	<input type="button" style="background-color: #9c27b0;color: #ffffff;border-color: #204d74;text-transform: uppercase;font-family: fantasy; font-size: large;" value="<?php echo $this->l('list_clear_filtering');?>" id='search_clear' class="search_clear">
        </div>
	</div>
	<div class="pDiv" style="font-size: larger;font-family: fantasy;">
		<div class="pDiv2">
			<div class="pGroup">
				<span class="pcontrol">
					<?php list($show_lang_string, $entries_lang_string) = explode('{paging}', $this->l('list_show_entries')); ?>
					<?php echo $show_lang_string; ?>
					<select name="per_page" id='per_page' style="border-radius: 3px; height: 24px;" class="per_page">
